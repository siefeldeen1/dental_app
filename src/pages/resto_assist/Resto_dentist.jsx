...
import '../../pages/dentist/dentist.css'

import Side_bar from '../sidebar/side_bar'
import Header from '../../pages/dentist/commpounts/header'; 
import Table from '../../pages/dentist/commpounts/table_under';
import Tool_bar from '../../pages/dentist/commpounts/tool_bar';
...
return()=>{  
   ...
   .then((data)=>{
     console.log("img_data",data[data.length - 1].patient_id);
    //  navigate(`/resto_assist/:${data[data.length - 1].patient_id}`)
     navigate(`/${data[data.length - 1].patient_id}_img:${0}`)
